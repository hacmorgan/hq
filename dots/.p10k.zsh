# Generated by Powerlevel10k configuration wizard on 2019-12-15 at 20:19 AEDT.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 38148.
# Wizard options: awesome-fontconfig + powerline, large icons, classic, dark, time,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%240F╰─ %160F:%220F:%082F:%033F:'
